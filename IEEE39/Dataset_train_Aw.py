...
#Dataload
mat = mat73.loadmat(
    'C:/Users/avarbella/Documents/MATLAB/test_cascades/GNN/small_IEEE39/DS_over.mat')  # load .mat file of
# unfiltered contigencies and trasform it into a dictionary
of = mat73.loadmat(
     'C:/Users/avarbella/Documents/MATLAB/test_cascades/GNN/small_IEEE39/label_over.mat')
node_f = mat73.loadmat(
    'C:/Users/avarbella/Documents/MATLAB/test_cascades/GNN/small_IEEE39/B_f_over.mat')
...
loader = DataLoader(data_list, shuffle=True)#WeightedRandomSampler(weights,len(data_list)))
torch.save(loader, 'C:/Users/avarbella/Documents/GraphGym-master/GraphGym-master/run/datasets/IEEE39/IEEE39/training_dataset_Awd.pt')
