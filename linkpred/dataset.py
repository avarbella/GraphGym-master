...
X = pd.read_csv('C:\\Users\\avarbella\\Documents\\MATLAB\\test_cascades\\link_prediction_dataproc\\X.csv', header=None)
X = X.astype('double')
B = pd.read_csv('C:\\Users\\avarbella\\Documents\\MATLAB\\test_cascades\\link_prediction_dataproc\\B.csv', header=None)
B = B.astype('double')
...
B_tot = torch.empty(size=(len(edge_index.H), 200))
